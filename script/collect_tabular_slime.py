...
if __name__ == '__main__':
    ...
    for ds in dataset:
        ...
        print(f"\n{ds.name} & {len(ds.label)} & {X.shape[1]} & {X.shape[0]} & {opaque_model.score(X_test, y_test):.2f}")
        ...
        # for idx in tqdm.tqdm(range(2)):
            ...
            for seed in tqdm.tqdm(config.SEED, desc="Seed", leave=False):
                ...
                explainer = slime.lime_tabular.LimeTabularExplainer(
